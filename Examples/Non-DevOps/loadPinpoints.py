...
parser.add_argument("-o",
                    "--output",
                    help="Path to report backup location.",
                    required=True)
parser.add_argument("-i",
                    "--input",
                    help="CSV file containing the information about the pin points",
                    required=True)
...
# If not all information are defined, the authentication
if len(authInfo) not in [0, 5]:
    print("ValueError: Some authentication parameters are missing. Authentication will be based on the information generated by sas-admin.")
    authInfo = {}

# Extract the content of the existing report
reportContent = getReportContent(
    reportName, path=reportLocation, auth=authInfo)
